...
function make_data($dbm, $adminname, $hashedAdminPass, $adminmail, $language, $groups)
{
    ...
    $dbm->insert('banner', " (bid, cid, imptotal, impmade, clicks, imageurl, clickurl, date, htmlbanner, htmlcode) VALUES (1, 1, 0, 1, 0, '" . XOOPS_URL . "/images/banners/xoops_flashbanner2.htm', 'https://xoops.org/', 1008813250, 1,'')");
    $dbm->insert('banner', " (bid, cid, imptotal, impmade, clicks, imageurl, clickurl, date, htmlbanner, htmlcode) VALUES (2, 1, 0, 1, 0, '" . XOOPS_URL . "/images/banners/xoops_banner_2.gif', 'https://xoops.org/', 1008813250, 0, '')");
    $dbm->insert('banner', " (bid, cid, imptotal, impmade, clicks, imageurl, clickurl, date, htmlbanner, htmlcode) VALUES (3, 1, 0, 1, 0, '" . XOOPS_URL . "/images/banners/banner.htm', 'https://xoops.org/', 1008813250, 1, '')");
    // default theme
    $time = time();
    ...
    if (file_exists(__DIR__ . '/../modules/system/language/' . $language . '/modinfo.php')) {
        require_once dirname(__DIR__) . '/modules/system/language/' . $language . '/modinfo.php';
    } else {
        require_once dirname(__DIR__) . '/modules/system/language/english/modinfo.php';
        $language = 'english';
    }
    ...
    $dbm->insert('config', " VALUES (39, 0, 3, 'footer', '_MD_AM_FOOTER', 'Powered by XOOPS &#169; 2001-" . date('Y', time())
                           . " <a href=\"https://xoops.org\" rel=\"external\" title=\"The XOOPS Project\">The XOOPS Project</a>', '_MD_AM_FOOTERDSC', 'textarea', 'text', 20)");
